defmodule ChatBotsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ChatBotsWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ChatBotsWeb.Gettext, "errors", msg, opts)
    # end
