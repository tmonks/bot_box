defmodule ChatBots.Fixtures.StabilityAiFixtures do
  use ChatBots.DataCase, only: [assert: 2]
  import Mox
  ...
  @doc """
  Returns the expected image file name for today with the given seed
  """
  def expected_file_name(seed \\ @seed) do
